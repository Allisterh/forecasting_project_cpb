...
# PA_RMSE_RF <- data.frame(matrix(ncol = length(horizons), nrow = 15))
# Unempl <- df[,2]
...
# 
# write.csv(PA_RMSE_RF, "~/Documents/MSc Econometrics/Blok 3/Seminar/R code/PA_rmse_rf3.csv", row.names=FALSE)
