...
write.csv(PA_BT_X_forecast, "/Users/vincentvanpul/Desktop/R_Output/PA_BT_X_forecast.csv", row.names=FALSE)
write.csv(PA_BT_F_forecast, "/Users/vincentvanpul/Desktop/R_Output/PA_BT_F_forecast.csv", row.names=FALSE)
write.csv(PA_BT_MAF_forecast, "/Users/vincentvanpul/Desktop/R_Output/PA_BT_MAF_forecast.csv", row.names=FALSE)
write.csv(PA_BT_MARX_forecast, "/Users/vincentvanpul/Desktop/R_Output/PA_BT_MARX_forecast.csv", row.names=FALSE)
write.csv(PA_BT_X_F_forecast, "/Users/vincentvanpul/Desktop/R_Output/PA_BT_X_F_forecast.csv", row.names=FALSE)
write.csv(PA_BT_X_MAF_forecast, "/Users/vincentvanpul/Desktop/R_Output/PA_BT_X_MAF_forecast.csv", row.names=FALSE)
write.csv(PA_BT_X_MARX_forecast, "/Users/vincentvanpul/Desktop/R_Output/PA_BT_X_MARX_forecast.csv", row.names=FALSE)
write.csv(PA_BT_F_MAF_forecast, "/Users/vincentvanpul/Desktop/R_Output/PA_BT_F_MAF_forecast.csv", row.names=FALSE)
write.csv(PA_BT_F_MARX_forecast, "/Users/vincentvanpul/Desktop/R_Output/PA_BT_F_MARX_forecast.csv", row.names=FALSE)
write.csv(PA_BT_MAF_MARX_forecast, "/Users/vincentvanpul/Desktop/R_Output/PA_BT_MAF_MARX_forecast.csv", row.names=FALSE)
write.csv(PA_BT_X_F_MAF_forecast, "/Users/vincentvanpul/Desktop/R_Output/PA_BT_X_F_MAF_forecast.csv", row.names=FALSE)
write.csv(PA_BT_X_F_MARX_forecast, "/Users/vincentvanpul/Desktop/R_Output/PA_BT_X_F_MARX_forecast.csv", row.names=FALSE)
write.csv(PA_BT_X_MAF_MARX_forecast, "/Users/vincentvanpul/Desktop/R_Output/PA_BT_X_MAF_MARX_forecast.csv", row.names=FALSE)
write.csv(PA_BT_F_MAF_MARX_forecast, "/Users/vincentvanpul/Desktop/R_Output/PA_BT_F_MAF_MARX_forecast.csv", row.names=FALSE)
write.csv(PA_BT_X_F_MAF_MARX_forecast, "/Users/vincentvanpul/Desktop/R_Output/PA_BT_X_F_MAF_MARX_forecast.csv", row.names=FALSE)
