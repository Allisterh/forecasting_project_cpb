...
CPB_Direct_BT_X_forecast <- read.csv("~/Documents/MSc Econometrics/Blok 3/Seminar/R code/CPB/BT/Direct/CPB_BT_X_forecast.csv")
CPB_Direct_BT_F_forecast <- read.csv("~/Documents/MSc Econometrics/Blok 3/Seminar/R code/CPB/BT/Direct/CPB_BT_F_forecast.csv")
CPB_Direct_BT_MAF_forecast <- read.csv("~/Documents/MSc Econometrics/Blok 3/Seminar/R code/CPB/BT/Direct/CPB_BT_MAF_forecast.csv")
CPB_Direct_BT_MARX_forecast <- read.csv("~/Documents/MSc Econometrics/Blok 3/Seminar/R code/CPB/BT/Direct/CPB_BT_MARX_forecast.csv")
CPB_Direct_BT_X_F_forecast <- read.csv("~/Documents/MSc Econometrics/Blok 3/Seminar/R code/CPB/BT/Direct/CPB_BT_X_F_forecast.csv")
CPB_Direct_BT_X_MAF_forecast <- read.csv("~/Documents/MSc Econometrics/Blok 3/Seminar/R code/CPB/BT/Direct/CPB_BT_X_MAF_forecast.csv")
CPB_Direct_BT_X_MARX_forecast <- read.csv("~/Documents/MSc Econometrics/Blok 3/Seminar/R code/CPB/BT/Direct/CPB_BT_X_MARX_forecast.csv")
CPB_Direct_BT_F_MAF_forecast <- read.csv("~/Documents/MSc Econometrics/Blok 3/Seminar/R code/CPB/BT/Direct/CPB_BT_F_MAF_forecast.csv")
CPB_Direct_BT_F_MARX_forecast <- read.csv("~/Documents/MSc Econometrics/Blok 3/Seminar/R code/CPB/BT/Direct/CPB_BT_F_MARX_forecast.csv")
CPB_Direct_BT_MAF_MARX_forecast <- read.csv("~/Documents/MSc Econometrics/Blok 3/Seminar/R code/CPB/BT/Direct/CPB_BT_MAF_MARX_forecast.csv")
CPB_Direct_BT_X_F_MAF_forecast <- read.csv("~/Documents/MSc Econometrics/Blok 3/Seminar/R code/CPB/BT/Direct/CPB_BT_X_F_MAF_forecast.csv")
CPB_Direct_BT_X_F_MARX_forecast <- read.csv("~/Documents/MSc Econometrics/Blok 3/Seminar/R code/CPB/BT/Direct/CPB_BT_X_F_MARX_forecast.csv")
CPB_Direct_BT_X_MAF_MARX_forecast <- read.csv("~/Documents/MSc Econometrics/Blok 3/Seminar/R code/CPB/BT/Direct/CPB_BT_X_MAF_MARX_forecast.csv")
CPB_Direct_BT_F_MAF_MARX_forecast <- read.csv("~/Documents/MSc Econometrics/Blok 3/Seminar/R code/CPB/BT/Direct/CPB_BT_F_MAF_MARX_forecast.csv")
CPB_Direct_BT_X_F_MAF_MARX_forecast <- read.csv("~/Documents/MSc Econometrics/Blok 3/Seminar/R code/CPB/BT/Direct/CPB_BT_X_F_MAF_MARX_forecast.csv")
